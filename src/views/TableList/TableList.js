...
class TableList extends React.Component {
    ...
    render() {
        ...
        let monthName = ""
        if (monthTemp[5] !== undefined) {
            monthName = monthTemp[5].month
        }
        let temp10 = { month: 5, value: localStorage.getItem("avgTempMonth10") };
        let temp11 = { month: 6, value: localStorage.getItem("avgTempMonth11") };
        let temp12 = { month: 7, value: localStorage.getItem("avgTempMonth12") };
        console.log("thang7",temp12);
        ...
        let humi10 = { month: 5, value: localStorage.getItem("avgHumiMonth10") };
        let humi11 = { month: 6, value: localStorage.getItem("avgHumiMonth11") };
        let humi12 = { month: 7, value: localStorage.getItem("avgHumiMonth12") };
                            ...
                            <CardBody>
                                <GridItem sm={12}>
                                    <Card chart>
                                        ...
                                        <CardBody style={{ textAlign: "center" }}>
                                            <h4 className={classes.cardTitle}>Thống kê nhiệt độ và độ ẩm theo ngày của Tháng {monthName}</h4>
                                        </CardBody>
                                ...
                                <GridItem sm={12}>
                                    <Card chart>
                                        ...
                                        <CardBody style={{ textAlign: "center" }}>
                                            <h4 className={classes.cardTitle}>Thống kê nhiệt độ và độ ẩm trung bình tuần của Tháng {monthName}</h4>
                                        </CardBody>
                                    </Card>
                                </GridItem>
                            </CardBody>
